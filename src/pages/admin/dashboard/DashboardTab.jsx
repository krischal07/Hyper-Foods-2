          ...
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 hover:shadow-blue-600 border-black-500 text-black-500 rounded-lg text-xl shadow-[inset_0_0_3px_rgba(0,0,0,0.1)]  px-5 py-1.5 text-center bg-[#605d5d12] "
                >
              ...
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 border-pink-500 bg-[#605d5d12] text-pink-500  hover:shadow-pink-700  rounded-lg text-xl shadow-[inset_0_0_3px_rgba(0,0,0,0.1)]    px-5 py-1.5 text-center "
                >
                  <div className="flex gap-2 items-center">
                                ...
                                <div
                                  onClick={() => {
                                    const confirmDelete = window.confirm(
                                      `Are you sure you want to delete the Carasoule:${item.title}`
                                    );
                                    if (confirmDelete) {
                                      deleteCarasoule(item.id);
                                    } else {
