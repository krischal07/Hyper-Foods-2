  ...
  return (
    <div className="bg-white sticky top-0 z-50  ">
      ...
      <header className="relative bg-white">
        <p
          className="flex h-10 items-center justify-center bg-[#013e72] px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
          style={{
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={"/"} className="flex">
                  <div className="flex ">
                    <img
                      src={hyperlogo}
                      className="px-2 py-1 border-e-red-500 h-20"
                    />
